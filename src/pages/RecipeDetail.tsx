...
const RecipeDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-amber-100 to-orange-100">
      ...
      <div className="relative z-10 w-full mx-auto pb-20 px-4 sm:px-6 md:max-w-2xl lg:max-w-3xl xl:max-w-4xl">
        {isLoading ? (
          <div className="p-6">
          ...
          <div className="p-6">
            <Card className="backdrop-blur-sm bg-white/90 p-6 shadow-lg rounded-xl border-0">
